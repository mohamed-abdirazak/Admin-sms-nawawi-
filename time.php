    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="fee_setup.php"><i class="fa fa-circle-o"></i> Fee register</a></li>
          <li><a href="fee_group.php"><i class="fa fa-circle-o"></i>Fee register (Class) </a></li>
          <li><a href="fee_search_class.php"><i class="fa fa-circle-o"></i>Fee search (by class)</a></li>
          <li><a href="fee_table.php"><i class="fa fa-circle-o"></i>Fee table </a></li>
      </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              ...
              <li><a href="time_table_class_search.php"><i class="fa fa-table"></i>Time table list </a></li>
          </ul>
        </li>
      </ul>
    </section>
