...
<head>
  ...
  <title>Table exam| Dashboard</title>
...
<?php
  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="student_attendance.php"><i class="fa fa-file"></i>Attendance Setup</a></li>
          <li><a href="student_attendance_table.php"><i class="fa fa-table"></i>Attendance list </a></li>
      </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="row">
            <div class="col-sm-10">
                ...
                <a href="student_attendance.php" class="btn" style="background-color:#FE8314;color:white;" role="button">
...
<script>
        ...
        {
            $.ajax({
            url:"student_attendance_table_code.php",
            method:"POST",
            data:{query:query},
